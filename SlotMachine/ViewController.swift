...
//  SlotMachine
//
//  Created by Mauro Consiglio on 19/11/14.
...
class ViewController: UIViewController {
    ...
    let kMarginForSlotHeight:CGFloat = 2.0
    let kMarginForSlotWidth:CGFloat = 20
    ...
    func setupSecondContainer(containerView: UIView) {
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            ...
            for var slotNumber = 0; slotNumber < kNumberOfSlots; ++slotNumber {
                ...
                slotImageView.frame = CGRect(x: containerView.bounds.origin.x + (containerView.bounds.size.width * CGFloat(containerNumber) * kThird) + kMarginForSlotWidth, y: containerView.bounds.origin.y + (containerView.bounds.size.height * CGFloat(slotNumber) * kThird), width: containerView.bounds.width * kThird - (kMarginForSlotWidth * 2), height: containerView.bounds.height * kThird - kMarginForSlotHeight)
